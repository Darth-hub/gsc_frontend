...
import Gmail_svg from './Gmail_svg';
  ...
  return (
    <StyledWrapper>
      <div className="input-wrapper ">
        ...
        <button className="Subscribe-btn cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" width={40} height={10} viewBox="0 0 38 15" className="arrow cursor-pointer">
